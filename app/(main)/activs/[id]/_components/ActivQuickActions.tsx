...
import { Pencil, Play, Save, Sticker, Trash2 } from 'lucide-react';
import { BtnDanger, BtnPrimary, BtnSecondary } from '@/components/ui';
import { STATUS_OPEN, STATUS_PLANNED } from '@/lib/api/statuses';
...
export function ActivQuickActions(props: Props) {
  const { statusId, acting, canEdit, canDelete, isLocked, onDelete, onEdit } = props;
